...
function lateralPanelParameter() {
    ...
    const widthParameterChanges = (valueAsNumber: number) => {
        if(gameIsRunning === false){  const value: number = Number(valueAsNumber)
    ...
    const isCustomGrid = (boolean: boolean) => {
        dispatch(setIsCustomGrid(boolean))
    }
            ...
            <div className='mt-1  rounded-md p-2.5  bg-slate-700 bg-opacity-80  '>
                ...
                <form action="border-0 border-b border-slate-600 pb-2">
                    ...
                    <div className='  grid grid-cols-12 mt-2  ' >
                        ...
                        <input type="range" value={gridwidthParameter} min={1} max={25} name="x" id="x" onChange={event => { widthParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300 col-start-4 col-span-6' />
                        <input type="number" value={gridwidthParameter} min={1} max={25} name="x" id="x" onChange={event => { widthParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300  text-opacity-100  border-2 border-opacity-100 border-slate-600 col-start-11 col-span-2 bg-transparent text-center ' />
                    </div>
                    <div className='  grid grid-cols-12 mt-2  '>
                        <label htmlFor="y" className='text-slate-300 capitalize col-span-2 opacity-80'>height</label>
                        <input type="range" value={gridHeightParameter} min={1} max={25} name="y" id="y" onChange={event => { heightParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300 col-start-4 col-span-6' />
                        <input type="number" value={gridHeightParameter} min={1} max={25} name="y" id="y" onChange={event => { heightParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300  text-opacity-100  border-2 border-opacity-100 border-slate-600 col-start-11 col-span-2 bg-transparent text-center ' />
                    </div>
                    <div className='  grid grid-cols-12 mt-2  '>
                        <label htmlFor="z" className='text-slate-300 capitalize col-span-2 opacity-80'>depth</label>
                        <input type="range" value={gridDepthParameter} min={1} max={25} name="z" id="z" onChange={event => { depthParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300 col-start-4 col-span-6' />
                        <input type="number" value={gridDepthParameter} min={1} max={25} name="z" id="z" onChange={event => { depthParameterChanges((event.target.valueAsNumber)) }} className='text-slate-300  text-opacity-100  border-2 border-opacity-100 border-slate-600 col-start-11 col-span-2 bg-transparent text-center ' />
                    </div>
                    <div className='  grid grid-cols-12 mt-2  '>
                        <label htmlFor="z" className='text-slate-300 capitalize col-span-4 opacity-80'>cube size</label>
